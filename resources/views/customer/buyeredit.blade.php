                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="contact__foasdrm">
                                ...
                                <br />
                                <form class="contact__form--inner" action="{{ route('postEditBuyerInformation') }}" method="POST" autocomplete="off">
                                    @csrf()
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input1">First Name <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="firstname" id="input1" placeholder="Your First Name" type="text" value="{{ $customer->fname }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input2">Last Name <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="lastname" id="input2" placeholder="Your Last Name" type="text" value="{{ $customer->lname }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3">Address <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="address" id="input3" placeholder="Address" type="text" value="{{ $customer->address }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3">Address II</label>
                                                <input class="contact__form--input" name="address2" id="input3" placeholder="Address II (optional)" type="text" value="{{ $customer->address2 }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <div class="checkout__input--list checkout__input--select select">
                                                ...
                                                <option value="{{ $country->id }}" @php if($country->id == $customer->country){ echo 'selected';} @endphp>{{ $country->name }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="co-lg-6 col-md-6">
                                            ...
                                            <div class="bstate checkout__input--list checkout__input--select select">
                                                ...
                                                <select class="checkout__input--select__field border-radius-5" name="state" id="bstate" style="border-color: orange; margin-bottom:10px">
                                                    @foreach($states as $state)
                                                        <option value="{{ $state->id }}" @php if($customer->state == $state->id){ echo 'selected'; } @endphp>{{ $state->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="checkout__input--list">
                                                <label>
                                                    <input class="box1 checkout__input--field border-radius-5" placeholder="State" name="stateother" id="bstateother"  type="text" value="{{ $customer->state }}" style="border-color: orange;">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                ...
                                                <input class="contact__form--input" name="city" id="input3" placeholder="City" type="text" value="{{ $customer->city }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3">Postal Code <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="postalcode" id="input3" placeholder="Postal Code" type="text" value="{{ $customer->postalcode }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3">Email Address <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="email" id="input3" placeholder="Email Address" type="email" value="{{ $customer->email }}" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3">Mobile Number <span class="contact__form--label__star">*</span></label>
                                                <input class="contact__form--input" name="mobile" id="input3" placeholder="Mobile Number" type="number" value="{{ $customer->mobile }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            <div class="contact__form--list mb-20">
                                                <label class="contact__form--label" for="input3"></label>
                                                <input class="" name="shippingaddresssame" type="checkbox"> Shipping address same as buyer address
                                            </div>
                                        </div>
                                    </div>
