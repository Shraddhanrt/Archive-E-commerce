      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Orders Tracking Code</span>
            <table class="main">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi {{ $data['name'] }},</p>
                        <p>
                          Your item(s) has been submitted to courier agent. click on below tracking url to tracking your item(s).
                          <br /> <br /> <br />
                          <a style="padding:10px; background-color:pink" href="{{ $data['trakinglink'] }}"> Tracking URL</a>
                          <br /> <br /> <br />
                        </p>
