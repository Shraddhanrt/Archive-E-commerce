      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">Ritzenchantress Booking Conformation #</span>
            <table class="main">
                ...
                <td class="wrapper">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <p>Hi {{ $data['fname'] }},</p>
                        <p>Thank You for your booking. You order has been replaced.</p>
                        <p>You can click here to view your invoice</p>
                        <p>
