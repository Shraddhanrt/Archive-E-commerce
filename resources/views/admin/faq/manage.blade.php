@extends('layouts.app', ['title' => __('Manage Faq')])
@section('content')
              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <div class="col-md-4" style="text-align: right;">
                      <a href="{{ route('getAddFaq') }}" class="btn btn-primary">Add</a>
                  </div>
              </div>
            </div>
            @if (session('status'))
                  ...
                  <tr>
                   ...
                   <th>
                     @if($item->product_id == null)
                      None
                    @else
                    @php $product = App\Models\Product::where('id', $item->product_id)->limit(1)->first(); @endphp
                    {{ $product->name }}
                    @endif
                   </th>
                   <th>{{ $item->created_at }}</th>
                    ...
                    <td class="text-right">
                      <a href="{{ route('getFaqEdit', $item->id) }}">Edit</a> | <a href="{{ route('getDeleteFaq', $item->id) }}">Delete</a>
                    </td>
                  </tr>
                  @endforeach
