@extends('layouts.app', ['title' => __('Add Faq')])
@section('content')
            ...
            <!-- Card stats -->
                ...
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                      <h6 class="h2 text-white d-inline-block mb-0">Add Faq</h6>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('postFaqAdd') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (session('status'))
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="question" class="form-control form-control-alternative" required>
                            </div>
                           
                            <div class="form-group">
                                <label class="form-control-label" for="input-email">{{ __('Answer') }}</label>
                                <textarea id="detail" name="answer" class="form-control form-control-alternative"></textarea>
                            </div>
