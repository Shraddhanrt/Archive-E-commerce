@extends('layouts.app', ['title' => __('Manage Diet Plan')])
@section('content')
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <div class="row">
                <div class="col-md-8">
                    <h3 class="mb-0">Manage Diet Plan</h3>
                  </div>
                  <div class="col-md-4" style="text-align: right;">
                      <a href="{{ route('getAddDiet') }}" class="btn btn-primary">Add</a>
                  </div>
              </div>
            </div>
            @if (session('status'))
                ...
                <tbody class="list">
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="{{ asset('site/uploads/diets/'.$item->photo) }}">
                        </a>
                      </div>
                    </th>
                   <td>{{ $item->title }}</td>
                   <th>{{ $item->created_at }}</th>
                    ...
                    <td class="text-right">
                      <a href="{{ route('getDietEdit', $item->id) }}">Edit</a> | <a href="{{ route('getDeleteDiet', $item->id) }}">Delete</a>
                    </td>
                  </tr>
                  @endforeach
