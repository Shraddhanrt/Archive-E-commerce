@extends('layouts.app', ['title' => __('Add Testimonial')])
@section('content')
            ...
            <!-- Card stats -->
                ...
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                      <h6 class="h2 text-white d-inline-block mb-0">Add Testimonial</h6>
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="mb-0">{{ __('Add Testimonial') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('postTestimonialAdd') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (session('status'))
