...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" method="POST" action="{{ route('postChangeOrderStatus') }}" enctype="multipart/form-data">
      <div class="modal-body">
          @csrf()
          <div class="mb-3">
              <div class="">
                  <input type="radio" name="orderstatus" value="Pending" required> <img src="{{ asset('site/images/pendingorder.png') }}" alt="" width="30"> Order Pending
              </div>
          </div>
          <div class="mb-3">
            <div class="">
                <input type="radio" name="orderstatus" value="Shipped"  required> <img src="{{ asset('site/images/delivered.png') }}" alt="" width="30"> Order Delivered to Courier
            </div>
          </div>
          <div class="mb-3">
            <div class="">
                <input type="radio" name="orderstatus" value="Delivered" required> <img src="{{ asset('site/images/ordercomplete.png') }}" alt="" width="30"> Order Completed
            </div>
          </div>
          <hr>
          <div class="mb-3">
            <div class="">
                <input type="checkbox" name="notification" value="emailsend"> Notification send via email
