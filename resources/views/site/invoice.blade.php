                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <hr>
                            <img src="{{ $order->shippingcompanylogo }}" alt="" width="120"> {{ $order->shippingcompany }} <br />
                    ...
                    <div class="text-95 col-sm-4 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">ID:</span> #RITZ-{{ $order->id }}</div>
