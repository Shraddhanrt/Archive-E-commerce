@extends('site.template', ['title' => __($blog->title)])
@section('content')
        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__content--title text-white mb-25">{{ $blog->title }}</h1>
                ...
                <div class="blog__details--wrapper">
                    <div class="entry__blog">
                        ...
                        <div class="blog__thumbnail mb-30">
                            <img class="blog__thumbnail--img border-radius-10" src="{{ asset('site/uploads/blogs/'.$blog->photo) }}" alt="blog-img">
                        </div>
