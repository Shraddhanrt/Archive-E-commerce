                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-12">
                                                    <div class="checkout__input--list ">
                                                        @php
                                                            $buyercountry = App\Models\Country::where(
                                                                'id',
                                                                $order->buyer_country,
                                                            )
                                                                ->limit(1)
                                                            ...
                                                            if ($order->buyer_country == '136') {
                                                                $buyerstateinfo = App\Models\State::where(
                                                                    'id',
                                                                    $order->buyer_state,
                                                                )
                                                                    ->limit(1)
                                                                    ->first();
                                                                $buyerstatename = $buyerstateinfo->name;
                                                            } else {
                                                                $buyerstatename = $order->buyer_state;
                                                            }
                                                        @endphp
                                                        <strong>
                                                            <h5>{{ $order->buyer_fname }} {{ $order->buyer_lname }}</h5>
                                                        </strong>
                                                        <h5>{{ $order->buyer_address }}</h5>
                                                        <h5>{{ $order->buyer_address1 }}</h5>

                                                        <h5>{{ $order->buyer_postal_code }} {{ $order->buyer_city }},
                                                            {{ $buyerstatename }}, {{ $buyercountry->name }} </h5>
                                    ...
                                    <div class="section__shipping--address__content">
                                        <div class="row">
                                            <div class="col-lg-6 mb-12">
                                                <div class="checkout__input--list ">
                                                    @php
                                                        $scountry = App\Models\Country::where(
                                                            'id',
                                                        ...
                                                        if ($order->receiver_country == '136') {
                                                            $sstateinfo = App\Models\State::where(
                                                                'id',
                                                                $order->receiver_state,
                                                            )
                                                                ->limit(1)
                                                                ->first();
                                                            $statename = $sstateinfo->name;
                                                        } else {
                                                            $statename = $order->receiver_state;
                                                        }
                                                    @endphp
                                                    <h5>{{ $order->receiver_fname }} {{ $order->receiver_lname }}</h5>
                                                    <h5>{{ $order->receiver_address }}</h5>
                                                    <h5>{{ $order->receiver_address1 }}</h5>
                                                    <h5>{{ $order->receiver_postal_code }} {{ $statename }},
                                                        {{ $order->receiver_state }}, {{ $scountry->name }}</h5>
                                    ...
                                    <tbody class="cart__table--body">
                                        @if (Session::get('cartcode'))
                                            ...
                                            @foreach ($getcartdetails as $cat)
                                                <?php $getproductC = App\Models\Product::where('id', $cat->product_id)
                                                    ->limit(1)
                                                    ->first(); ?>
                                                        ...
                                                        <div class="product__image two  d-flex align-items-center">
                                                            <div class="product__thumbnail border-radius-5">
                                                                <a href=""><img class="border-radius-5"
                                                                        src="{{ asset('site/uploads/products/' . $getproductC->photo) }}"
                                                                        alt="cart-product"></a>
                                                                <span
                                                                    class="product__thumbnail--quantity">{{ $cat->qty }}</span>
                                                            </div>
                                                            <div class="product__description">
                                                                <h3 class="product__description--name h4"><a
                                                                        href="">{{ $getproductC->name }}</a></h3>
                                                                <span class="product__description--variant">Weight:
                                                                    {{ $getproductC->weight }} kg</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="cart__table--body__list">
                                ...
                                <table class="checkout__total--table">
                                    <tbody class="checkout__total--body">
                                        ...
                                        @if (auth()->guard('agent')->check())
                                            ...
                                            @endphp
                                            <tr class="checkout__total--items">
                                                <td class="checkout__total--title text-left">Agent Discount
                                                    ({{ $agent->discount }}%) </td>
                                                <td class="checkout__total--amount text-right">MYR
                                                    {{ $grandtotal * ($agent->discount / 100) }}</td>
                                            </tr>
                                            <tr class="checkout__total--items">
                                                <td class="checkout__total--title text-left">Total </td>
                                                <td class="checkout__total--amount text-right">MYR
                                                    {{ $grandtotal - $grandtotal * ($agent->discount / 100) }}</td>
                                            </tr>
                                        @endif
                                        <tr class="checkout__total--items">
                                        ...
                                        @if ($order->coupon_id)
                                            <tr class="checkout__total--items">
                                                <td class="checkout__total--title text-left">Promo Code Discount</td>
                                                <td class="checkout__total--calculated__text text-right">
                                                    - MYR {{ $order->discount }} <br />
                                                </td>
                                            </tr>
                                        @endif
                                        <tr class="checkout__total--items">
                                            ...
                                            <div>
                                                ...
                                                <div class="guarantee__safe--checkout">
                                                    ...
                                                    <img class="guarantee__safe--checkout__img"
                                                        src="{{ asset('site/assets/img/other/onlinepayment.jpg') }}"
                                                        alt="Payment Image" style="margin-top: 5px;">
                                                </div>
                                            </div>
                                            @php
                                                $order = App\Models\Order::where('code', Session::get('cartcode'))
                                                    ->limit(1)
                                                    ->first();
                                            ...
                                            @if ($order->paymentstatus == 'N')
                                                <form action="{{ $payment_url }}" method="POST">
                                                    ...
                                                    <input type="hidden" name="name"
                                                        value="{{ $order->buyer_fname }}">
                                                    <input type="hidden" name="email"
                                                        value="{{ $order->buyer_email }}">
                                                    <input type="hidden" name="phone"
                                                        value="{{ $order->buyer_mobile }}">
                                                    <input type="submit" class="btn primary__btn"
                                                        style="width: 100%; text-align: center; margin-top: 15px;"
                                                        value="Pay Now">
                                                </form>
                                            @else
                                                <a href="" class="btn primary__btn"
                                                    style="width: 100%; text-align: center; margin-top: 15px;">Already
                                                    Paid</a>
                                            @endif
                                            <br /> <br />
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div>
                                                ...
                                                <div class="guarantee__safe--checkout">
                                                    <!-- <h5 class="guarantee__safe--checkout__title">Guaranteed Safe Checkout</h5> -->
                                                    <img class="guarantee__safe--checkout__img"
                                                        src="{{ asset('site/images/paypal.png') }}" alt="Payment Image"
                                                        style="margin-top: 5px;" width="200">
                                                </div>
                                            </div>
                                            <a href="{{ route('payWithpaypal') }}" class="btn primary__btn"
                                                style="width: 100%; text-align: center; margin-top: 15px;">Pay Now</a>
                                            <br /> <br />
                                        </div>
                                    </div>
                                @elseif($order->paymentmethod == 'esewa')
                                    <a href="{{route('getPayWithEsewa', $order->id)}}" class="btn primary__btn">Pay With eSewa</a>
                                @else
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div>
                                                ...
                                                <div class="guarantee__safe--checkout">
                                                    <!-- <h5 class="guarantee__safe--checkout__title">Guaranteed Safe Checkout</h5> -->
                                                    <img class="guarantee__safe--checkout__img"
                                                        src="{{ asset('site/images/directbanktransfer.png') }}"
                                                        alt="Payment Image" style="margin-top: 5px;" width="200">
                                                    <p>
                                                    ...
                                                    <p style="line-height:20px; color:red;">Note: After successfully bank
                                                        transfer please send your bank slip to +6012 654 1955</p>
                                                </div>
                                            </div>
                                            <a href="{{ route('getDirectBankTransfer') }}" class="btn primary__btn"
                                                style="width: 100%; text-align: center; margin-top: 15px;">Done</a>
                                            <br /> <br />
                                        </div>
                                    </div>
                                @endif
