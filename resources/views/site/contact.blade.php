@extends('site.template', ['title' => __('Contact Us')])
@section('content')
        ...
        <div class="main__contact--area position__relative">
            ...
            <div class="contact__info border-radius-5">
                <div class="contact__info--items">
                    <h3 class="contact__info--content__title text-white mb-15">RITZ ENCHANTRESS SDN. BHD.</h3>
                </div>
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">Contact in whatsapp<br> <a href="https://wa.me/60126541955" target="_blank">+6012 654 1955</a></p>
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white"> <a href="mailto:ritzenchantress@gmail.com">ritzenchantress@gmail.com</a></p> 
                        </div>
                    </div>
                </div>
                <div class="contact__info--items">
                    ...
                    <div class="contact__info--items__inner d-flex">
                        ...
                        <div class="contact__info--content">
                            <p class="contact__info--content__desc text-white">  The CEO, Bukit Jambul,
                ...
                <div class="contact__info--items">
                    ...
                    <ul class="contact__info--social d-flex">
                        <li class="contact__info--social__list">
                            <a class="contact__info--social__icon" target="_blank" href="https://www.facebook.com/RitzTeam">
                        ...
                        <li class="contact__info--social__list">
                            <a class="contact__info--social__icon" target="_blank" href="https://www.instagram.com/ritz_enchantress_hq/?igshid=YmMyMTA2M2Y=">
